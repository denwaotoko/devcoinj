 ...
 * <a href="https://en.devcoin.it/wiki/Protocol_specification">the protocol specification</a>.</p>
 *
 ...
 * <li>Message.devcoinSerializeToStream() needs to be properly subclassed</li>
 * </ul>
 */
public class BitcoinSerializer {
    ...
    public void serialize(Message message, OutputStream out) throws IOException {
        ...
        serialize(name, message.devcoinSerialize(), out);
    }
