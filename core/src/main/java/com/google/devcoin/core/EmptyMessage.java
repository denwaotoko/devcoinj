 ...
 * Currently this includes getaddr, ping, verack as well as the special devcoinj class UnknownMessage
 *
 * @author git
 */
public abstract class EmptyMessage extends Message {
    ...
    @Override
    final protected void devcoinSerializeToStream(OutputStream stream) throws IOException {
    }
