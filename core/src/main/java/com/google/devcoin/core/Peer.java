...
public class Peer {
    ...
    private static class GetDataRequest {
        ...
        // a nasty hack that relies on the fact that devcoin-qt is single threaded and processes messages in order.
    ...
    private void blockChainDownloadLocked(Sha256Hash toHash) throws IOException {
        ...
        //
        //   https://en.devcoin.it/wiki/Protocol_specification#getblocks
        //
    ...
    private boolean isNotFoundMessageSupported() {
        return vPeerVersionMessage.clientVersion >= 32400;
    }
