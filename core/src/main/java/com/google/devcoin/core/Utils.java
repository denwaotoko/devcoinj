 ...
 * To enable debug logging from the library, run with -Ddevcoinj.logging=true on your command line.
 */
public class Utils {
     ...
     */
    public static String devcoinValueToFriendlyString(BigInteger value) {
     ...
     */
    public static String devcoinValueToPlainString(BigInteger value) {
        if (value == null) {
