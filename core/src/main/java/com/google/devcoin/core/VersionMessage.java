...
public class VersionMessage extends Message {
    ...
    @Override
    public void devcoinSerializeToStream(OutputStream buf) throws IOException {
        ...
        try {
            // My address.
            myAddr.devcoinSerialize(buf);
            // Their address.
            theirAddr.devcoinSerialize(buf);
        } catch (UnknownHostException e) {
     ...
     *
     * See <a href="https://en.devcoin.it/wiki/BIP_0014">BIP 14</a> for more information.
     *
