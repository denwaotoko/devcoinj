...
public class ChainSplitTest {
    ...
    public void testForking1() throws Exception {
        ...
        assertEquals("100.00", Utils.devcoinValueToFriendlyString(wallet.getBalance()));
        ...
        assertEquals("50.00", Utils.devcoinValueToFriendlyString(wallet.getBalance()));
        ...
        assertEquals("200.00", Utils.devcoinValueToFriendlyString(wallet.getBalance()));
    }
    ...
    private Block roundtrip(Block b2) throws ProtocolException {
        return new Block(unitTestParams, b2.devcoinSerialize());
    }
    ...
    public void txConfidenceLevels() throws Exception {
        ...
        assertEquals("250.00", Utils.devcoinValueToFriendlyString(wallet.getBalance()));
