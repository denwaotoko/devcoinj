...
public class FullBlockTestGenerator {
    ...
    public RuleList getBlocksToTest(boolean addSigExpensiveBlocks, boolean runLargeReorgs, File blockStorageFile) throws ScriptException, ProtocolException, IOException {
            ...
            public boolean add(Rule element) {
                if (outStream != null && element instanceof BlockAndValidity) {
                    try {
                        ...
                        byte[] block = ((BlockAndValidity)element).block.devcoinSerialize();
        ...
        // Extend the b24 chain to make sure devcoind isn't accepting b24
        ...
        Block b56;
        try {
            b56 = new Block(params, b57.devcoinSerialize());
        ...
        Block b64;
        {
            ...
            for (Transaction transaction : b64Created.getTransactions())
                transaction.devcoinSerialize(stream);
            ...
            Preconditions.checkState(Arrays.equals(stream.toByteArray(), b64.devcoinSerialize()));
        ...
        Block b71 = new Block(params, b72.devcoinSerialize());
