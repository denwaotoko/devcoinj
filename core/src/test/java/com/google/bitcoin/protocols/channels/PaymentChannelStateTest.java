...
public class PaymentChannelStateTest extends TestWithWallet {
    ...
    public void basic() throws Exception {
        ...
        Transaction refund = new Transaction(params, clientState.getIncompleteRefundTransaction().devcoinSerialize());
        ...
        Transaction multisigContract = new Transaction(params, clientState.getMultisigContract().devcoinSerialize());
        ...
        // Both client and server are now in the ready state. Simulate a few micropayments of 0.005 devcoins.
        ...
        chain.add(makeSolvedTestBlock(blockStore.getChainHead().getHeader(), multisigContract,
                                      new Transaction(params, closeTx.devcoinSerialize())));
    ...
    public void checkBadData() throws Exception {
        ...
        byte[] refundTxBytes = clientState.getIncompleteRefundTransaction().devcoinSerialize();
        ...
        byte[] multisigContractSerialized = clientState.getMultisigContract().devcoinSerialize();
    ...
    public void doubleSpendContractTest() throws Exception {
        ...
        doubleSpendContract = new Transaction(params, doubleSpendContract.devcoinSerialize());
